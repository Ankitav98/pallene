...
#define ZS_VALUE hvalue(ZS_SLOT)
    ...
    {
        lua_Integer x7 = luaH_getn(XS_VALUE);
        lua_Integer x8 /* NI */ = x7;
        lua_Integer x9 = luaH_getn(YS_VALUE);
        lua_Integer x10 /* NJ */ = x9;
        lua_Integer x11 = luaH_getn(ZS_VALUE);
        ...
        while ((x16 >= 0 ? x14 <= x15 : x14 >= x15)) {
            ...
            (void) x17;
            {
                ...
                if (TITAN_UNLIKELY(x18 >= XS_VALUE->sizearray)) {
                    titan_renormalize_array(L, XS_VALUE, x18, 12);
                }
                const TValue * x19 /* arrslot */ = &XS_VALUE->array[x18];
                ...
                while ((x24 >= 0 ? x22 <= x23 : x22 >= x23)) {
                    ...
                    (void) x25;
                    {
                        ...
                        if (TITAN_UNLIKELY(x26 >= YS_VALUE->sizearray)) {
                            titan_renormalize_array(L, YS_VALUE, x26, 14);
                        }
                        const TValue * x27 /* arrslot */ = &YS_VALUE->array[x26];
                        ...
                        while ((x32 >= 0 ? x30 <= x31 : x30 >= x31)) {
                            ...
                            (void) x33;
                            {
                                ...
                                if (TITAN_UNLIKELY(x34 >= ZS_VALUE->sizearray)) {
                                    titan_renormalize_array(L, ZS_VALUE, x34, 16);
                                }
                                const TValue * x35 /* arrslot */ = &ZS_VALUE->array[x34];
...
int luaopen_benchmarks_sillybench_purestack(lua_State *L)
{
    lua_checkstack(L, 4);
